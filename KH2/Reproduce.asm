...
-> True Kingdom Hearts I Command Menu
    @ 0x5AD283 => "tt1command.2dd"
    @ 0x5AD298 => "tt1command.2dd"

-> Allow Offline Play [DRM Compliant]
    @ 0x1493C8 => [75 27] to [EB 27]

-> Disable Title Screen FMV
    @ 0x2B066A => [90 90 90 90 90 90 90 90]

-> Rename Config File
    @ 0x5F7A10 => "/config_kh2.dat"
...
-> Show Forms in the Inventory
    @ 0x348B0C => [EB 45 90 90]
    @ 0x348B53 => [81 C3 00 00 20 00 EB B5]

# This took WAY too long to do.
-> Remove EpicID Check from Save Files
    @ 0x470EF8 => [90 90 90 90 90]
    @ 0x470F05 => [90 90]
    @ 0x470F10 => [EB 30]
...
-> Disengage Right Stick Config
    @ 0x2E2229 => [B0 01 90 90 90 90 90 90 90 90 90 90 90]

-> Controller Focus Check
    @ 0x10AE35 => [90 90]