...
namespace ReFined
{
    public class Variables
    {
        ...
        public static List<ushort[]> ARRY_ConfigMenu = new List<ushort[]>
        {
            ...
            new ushort[] { 0x0001, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000  },
            new ushort[] { 0x0001, 0xB71D, 0xB738, 0xB739, 0xB73A, 0xCE30, 0xB73B, 0xB73C, 0xB73D, 0xCE31  }
        };

        public static uint[] VALUE_NewGameAudio = new uint[] { 0x00000003, 0x0000E006, 0xFFFFFFFF, 0x000081C4, 0x000081D9, 0x000081C5, 0xFFFFFFFF, 0x000081D0, 0x000081DA, 0x000081D1, 0xFFFFFFFF };
