...
namespace ReFixed
{
	public class Variables
	{
		...
		public static string[] FormText = { "None", "Valor", "Wisdom", "Limit", "Master", "Final", "Anti" };
        public static string[] ModeText = { "Beginner Mode", "Standard Mode", "Proud Mode", "Critical Mode" };
		...
		public static ulong[] ObjentryAddresses =
		{
			0x24BFA72,
			0x24BFD72,
			0x24E7852
