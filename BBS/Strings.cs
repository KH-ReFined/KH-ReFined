    ...
    internal class Strings
    {
        ...
        public static string[][] DualAudio = new string[][]
        {
            ...
            new string[]
            {
                ...
                "Englisch\x00",
                "Japanisch\x00",
                "Wechsle in die Englische Sprachausgabe.\x0A\u2219\x59(Aktiviere einen signifikanten Ladevorgang,\x000Adamit die Anderungen in Kraft treten.)\x00",
                "Wechsle in die Japanische Sprachausgabe.\x0A\u2219\x59(Aktiviere einen signifikanten Ladevorgang,\x000Adamit die Anderungen in Kraft treten.)\x00"
            },
            ...
            new string[]
            {
                ...
                "InglÖís\x00",
                "JaponÖís\x00",
                "Cambia las voces a InglÖís.\x0A\u2219\x59(Se necesitan cargar múltiples elementos\x000Apara que surjan los cambios.)\x00",
                "Cambia las voces a JaponÖís.\x0A\u2219\x59(Se necesitan cargar múltiples elementos\x000Apara que surjan los cambios.)\x00"
            },
