...
extern "C"
{
	...
	public:
		...
		using Change_t = void(*)(AREA::INFO* self, AREA::INFO area);
		static Change_t Change;

		using Exit_t = void(*)();
		static Exit_t Exit;

		using MapJump_t = void(*)(AREA::INFO* area, uint32_t effectType, uint32_t delay, bool is_continue);
