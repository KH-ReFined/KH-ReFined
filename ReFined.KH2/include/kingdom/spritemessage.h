    ...
    namespace dk
    {
        class DLL_EXPORT SpriteMessage
        {
			...
			private:
				static bool _init()
				{
					RedirectFunction("\x40\x56\x48\x81\xEC\xF0\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x84\x24\xD0\x00\x00\x00\x48\x8B\xF1\x48\x8B\x89", "xxxxxxxxxxxx????xxxxxxxxxxxxxxxxx", reinterpret_cast<uint64_t>(drawMessage), 0x265);
					return true;
				}
