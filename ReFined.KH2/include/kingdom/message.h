...
extern "C"
{
	namespace YS
	{
		...
		{
		public:
			static inline char* (*GetData)(int id) = FindSignature<char*(*)(int)>("\x48\x89\x5C\x24\x08\x48\x89\x6C\x24\x10\x48\x89\x74\x24\x18\x57\x41\x56\x41\x57\x48\x83\xEC\x50\x45\x33\xF6\x48\x63\xE9\x33\xF6\x48\x8D\x3D\x00\x00\x00\x00\x4C\x8D\x3D\x00\x00\x00\x00", "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx????xxx????");
            static inline const size_t(*GetSize)(const char* message) = FindSignature<const size_t(*)(const char*)>("\x4C\x8B\xC1\x48\x8B\xD1\x48\x85\xC9\x74\x2E\x4C\x8D\x0D\x00\x00\x00\x00", "xxxxxxxxxxxxxx????");
            static inline char* (*Sprintf)(char* buff, const char* string, ...) = FetchFunctionFromCall<char*(*)(char*, const char*, ...)>("\x48\x89\x5C\x24\x08\x48\x89\x6C\x24\x10\x48\x89\x74\x24\x18\x57\x41\x56\x41\x57\x48\x83\xEC\x50\x33\xED\x4C\x8D\x3D", "xxxxxxxxxxxxxxxxxxxxxxxxxxxxx", 0x5D);

			static inline char* SizeTable = FetchRelativePointer<char*>("\x4C\x8B\xC1\x48\x8B\xD1\x48\x85\xC9\x74\x2E\x4C\x8D\x0D\x00\x00\x00\x00", "xxxxxxxxxxxxxx????", 0x0E);
