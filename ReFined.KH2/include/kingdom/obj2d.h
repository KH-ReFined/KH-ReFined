...
extern "C"
{
	namespace dk
	{
		...
		{
		public:
			static inline char* vftable = FetchRelativePointer<char*>("\x48\x89\x5C\x24\x08\x48\x89\x6C\x24\x10\x48\x89\x74\x24\x18\x57\x48\x83\xEC\x20\x8B\xEA\x48\x8D\xB9\x90\x0D\x00\x00", "xxxxxxxxxxxxxxxxxxxxxxxxxxxxx", 0x5C);
