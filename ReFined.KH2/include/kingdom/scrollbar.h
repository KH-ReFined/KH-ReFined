...
extern "C"
{
	namespace Tz
	{
		...
		public:
			...
			static inline void(*Loop)(char* scrollBar) = FindSignature<void(*)(char*)>("\x40\x53\x48\x83\xEC\x20\x48\x8B\xD9\x48\x8B\x09\xE8\x00\x00\x00\x00\x48\x8B\x0B\xBA\x01\x00\x00\x00", "xxxxxxxxxxxxx????xxxxxxxx");
			static inline void(*FadeOut)(char* scrollBar) = FindSignature<void(*)(char*)>("\x40\x53\x48\x83\xEC\x20\x48\x8B\xD9\x48\x8B\x09\xE8\x00\x00\x00\x00\x84\xC0\x74\x34\x48\x8B\x0B\x33\xD2\x48\x89\x7C\x24\x30\xE8", "xxxxxxxxxxxxx????xxxxxxxxxxxxxxx");
			static inline void(*Leave)(char* scrollBar) = FindSignature<void(*)(char*)>("\x40\x53\x48\x83\xEC\x20\x48\x8B\xD9\x48\x8B\x09\xE8\x00\x00\x00\x00\x84\xC0\x74\x0F\x48\x8B\x0B\x48\x8B\x01\x48\x83\xC4\x20\x5B", "xxxxxxxxxxxxx????xxxxxxxxxxxxxxx");
		};
	}
}