...
extern "C"
{
	namespace dk {
		...
		public:
			static inline void(*openPrizeWindow)(const char* message) = FindSignature<void(*)(const char*)>("\x40\x53\x48\x83\xEC\x20\x48\x8B\x15\x00\x00\x00\x00\x48\x8B\xD9\x4C\x63\x82\x00\x00\x00\x00", "xxxxxxxxx????xxxxxx????");

			static void openBoxWindow(const char* message, uint16_t image)
			{
				auto PROCESS_ITEMINFO = FindSignature< void(*)()>("\x48\x63\x15\x00\x00\x00\x00\x48\x8D\x05\x00\x00\x00\x00\x48\x8D\x0C\x52\xFF\xC2\x81\xE2\x07\x00\x00\x80\x7D\x07", "xxx????xxx????xxxxxxxxxxxxxx");
				char* ITEMINFO_QUEUE = FetchRelativePointer<char*>("\x48\x63\x15\x00\x00\x00\x00\x48\x8D\x05\x00\x00\x00\x00\x48\x8D\x0C\x52\xFF\xC2\x81\xE2\x07\x00\x00\x80\x7D\x07", "xxx????xxx????xxxxxxxxxxxxxx", 0x03) - 0x04;
