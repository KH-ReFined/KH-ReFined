...
YS::PARTY::get_partram_t YS::PARTY::get_partram = SignatureScan<YS::PARTY::get_partram_t>("\x48\x8B\x81\xC0\x05\x00\x00\x8B\x88\x50\x02\x00\x00\xE9", "xxxxxxxxxxxxxx");
