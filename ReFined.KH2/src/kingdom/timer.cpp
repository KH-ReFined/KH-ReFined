...
dk::TIMER::getTime_t dk::TIMER::getTime = ResolveFunctionFromCall<dk::TIMER::getTime_t>("\x40\x55\x53\x56\x57\x41\x56\x48\x8B\xEC\x48\x83\xEC\x60\x48\x8B\xD9\xE8", "xxxxxxxxxxxxxxxxxx", 0x10A);
dk::TIMER::isDown_t dk::TIMER::isDown = ResolveFunctionFromCall<dk::TIMER::isDown_t>("\x40\x55\x53\x56\x57\x41\x56\x48\x8B\xEC\x48\x83\xEC\x60\x48\x8B\xD9\xE8", "xxxxxxxxxxxxxxxxxx", 0x27F);
